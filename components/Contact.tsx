        ...
        <div className="max-w-5xl mx-auto bg-white p-8 md:p-16 shadow-sm border border-stone-100">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-12 relative" dir={dir}>
            {steps.map((step, index) => (
              ...
              >
                <div className="w-16 h-16 bg-stone-50 rounded-full flex items-center justify-center mb-6 border border-stone-100 group-hover:bg-stone-900 group-hover:text-white transition-all duration-500 relative">
          ...
          <motion.div 
            ...
            className="mt-20 flex flex-col items-center gap-8 border-t border-stone-50 pt-16 relative"
          >
            {/* Unified QR Code Tooltip for the bottom section */}
            <AnimatePresence>
              {showQR && (
                <motion.div
